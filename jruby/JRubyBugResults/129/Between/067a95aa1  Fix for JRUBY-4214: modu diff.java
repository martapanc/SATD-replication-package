diff --git a/spec/tags/1.8/ruby/core/module/module_function_tags.txt b/spec/tags/1.8/ruby/core/module/module_function_tags.txt
index f31cab6610..0212575313 100644
--- a/spec/tags/1.8/ruby/core/module/module_function_tags.txt
+++ b/spec/tags/1.8/ruby/core/module/module_function_tags.txt
@@ -1,3 +1,2 @@
 fails(JRUBY-2627):Module#module_function as a toggle (no arguments) in a Module body affects definitions when inside an eval even if the definitions are outside of it
 fails(JRUBY-2627):Module#module_function as a toggle (no arguments) in a Module body functions normally if both toggle and definitions inside a module_eval
-fails(JRUBY-4214):Module#module_function with specific method names can make accessible private methods
diff --git a/src/org/jruby/RubyModule.java b/src/org/jruby/RubyModule.java
index 5e6bb75227..14567094ad 100644
--- a/src/org/jruby/RubyModule.java
+++ b/src/org/jruby/RubyModule.java
@@ -243,2727 +243,2740 @@ public class RubyModule extends RubyObject {
