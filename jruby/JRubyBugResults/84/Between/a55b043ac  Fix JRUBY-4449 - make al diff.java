diff --git a/spec/tags/1.9/ruby/core/kernel/Integer_tags.txt b/spec/tags/1.9/ruby/core/kernel/Integer_tags.txt
deleted file mode 100644
index fecdfb595d..0000000000
--- a/spec/tags/1.9/ruby/core/kernel/Integer_tags.txt
+++ /dev/null
@@ -1,68 +0,0 @@
-fails(JRUBY-4449):Kernel.Integer raises a TypeError when passed nil
-fails(JRUBY-4449):Kernel.Integer ignores leading whitespace
-fails(JRUBY-4449):Kernel.Integer ignores trailing whitespace
-fails(JRUBY-4449):Kernel.Integer ignores an embedded _
-fails(JRUBY-4449):Kernel.Integer ignores a single leading +
-fails(JRUBY-4449):Kernel.Integer makes the number negative if there's a leading -
-fails(JRUBY-4449):Kernel.Integer accepts wholly lowercase alphabetic strings for bases > 10
-fails(JRUBY-4449):Kernel.Integer accepts wholly uppercase alphabetic strings for bases > 10
-fails(JRUBY-4449):Kernel.Integer accepts mixed-case alphabetic strings for bases > 10
-fails(JRUBY-4449):Kernel.Integer accepts alphanumeric strings for bases > 10
-fails(JRUBY-4449):Kernel.Integer parses the value as a hex number if there's a leading 0x and a base of 16
-fails(JRUBY-4449):Kernel.Integer is a positive hex number if there's a leading +0x and base of 16
-fails(JRUBY-4449):Kernel.Integer is a negative hex number if there's a leading -0x and a base of 16
-fails(JRUBY-4449):Kernel.Integer parses the value as a hex number if there's a leading 0X and a base of 16
-fails(JRUBY-4449):Kernel.Integer is a positive hex number if there's a leading +0X and base of 16
-fails(JRUBY-4449):Kernel.Integer is a negative hex number if there's a leading -0X and a base of 16
-fails(JRUBY-4449):Kernel.Integer parses the value as a binary number if there's a leading 0b and the base is 2
-fails(JRUBY-4449):Kernel.Integer is a positive binary number if there's a leading +0b and a base of 2
-fails(JRUBY-4449):Kernel.Integer is a negative binary number if there's a leading -0b and a base of 2
-fails(JRUBY-4449):Kernel.Integer parses the value as a binary number if there's a leading 0B and the base is 2
-fails(JRUBY-4449):Kernel.Integer is a positive binary number if there's a leading +0B and a base of 2
-fails(JRUBY-4449):Kernel.Integer is a negative binary number if there's a leading -0B and a base of 2
-fails(JRUBY-4449):Kernel.Integer parses the value as an octal number if there's a leading 0o and a base of 8
-fails(JRUBY-4449):Kernel.Integer is a positive octal number if there's a leading +0o and a base of 8
-fails(JRUBY-4449):Kernel.Integer is a negative octal number if there's a leading -0o and a base of 8
-fails(JRUBY-4449):Kernel.Integer parses the value as an octal number if there's a leading 0O and a base of 8
-fails(JRUBY-4449):Kernel.Integer is a positive octal number if there's a leading +0O and a base of 8
-fails(JRUBY-4449):Kernel.Integer is a negative octal number if there's a leading -0O and a base of 8
-fails(JRUBY-4449):Kernel.Integer parses the value as a decimal number if there's a leading 0D and a base of 10
-fails(JRUBY-4449):Kernel.Integer is a positive decimal number if there's a leading +0D and a base of 10
-fails(JRUBY-4449):Kernel.Integer is a negative decimal number if there's a leading -0D and a base of 10
-fails(JRUBY-4449):Kernel.Integer parses the value as a decimal number if there's a leading 0d and a base of 10
-fails(JRUBY-4449):Kernel.Integer is a positive decimal number if there's a leading +0d and a base of 10
-fails(JRUBY-4449):Kernel.Integer is a negative decimal number if there's a leading -0d and a base of 10
-fails(JRUBY-4449):Kernel#Integer raises a TypeError when passed nil
...
index 88277f4d7c..beb87c3e95 100644
