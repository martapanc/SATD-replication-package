...
index 64166cd818..b66785398c 100644
...
@@ -70,2076 +70,2081 @@ import org.hibernate.mapping.IdentifierCollection;
...
@@ -2199,1028 +2204,1033 @@ public final class HbmBinder {
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/quote/AssociatedDataPoint.java b/hibernate-core/src/test/java/org/hibernate/test/quote/AssociatedDataPoint.java
new file mode 100644
index 0000000000..6d0880bc8b
--- /dev/null
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/AssociatedDataPoint.java
@@ -0,0 +1,58 @@
+/* 
...
+	}
+}
diff --git a/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.hbm.xml b/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.hbm.xml
new file mode 100644
index 0000000000..25346f0c5c
--- /dev/null
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.hbm.xml
@@ -0,0 +1,65 @@
+<?xml version="1.0"?>
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.java b/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.java
new file mode 100644
index 0000000000..ade4bdb7b6
--- /dev/null
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/DataPoint.java
@@ -0,0 +1,92 @@
+/* 
+ * Hibernate, Relational Persistence for Idiomatic Java
+ * 
...
+	}
+}
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/House.java b/hibernate-core/src/test/java/org/hibernate/test/quote/House.java
similarity index 97%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/House.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/House.java
index 0e8eca2aab..ff10c21ecb 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/House.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/House.java
@@ -1,53 +1,53 @@
 /* 
  * Hibernate, Relational Persistence for Idiomatic Java
  * 
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Person.java b/hibernate-core/src/test/java/org/hibernate/test/quote/Person.java
similarity index 97%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Person.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/Person.java
index b99e250d21..18979c66d2 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Person.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/Person.java
@@ -1,56 +1,56 @@
 /* 
  * Hibernate, Relational Persistence for Idiomatic Java
  * 
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Phone.java b/hibernate-core/src/test/java/org/hibernate/test/quote/Phone.java
similarity index 94%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Phone.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/Phone.java
index 8fa149b839..48fdb78e3c 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Phone.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/Phone.java
@@ -1,45 +1,45 @@
-package org.hibernate.test.annotations.quote;
+package org.hibernate.test.quote;
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/QuoteGlobalTest.java b/hibernate-core/src/test/java/org/hibernate/test/quote/QuoteGlobalTest.java
similarity index 79%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/QuoteGlobalTest.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/QuoteGlobalTest.java
index c179cec84e..2e7f602cc5 100644
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/QuoteTest.java b/hibernate-core/src/test/java/org/hibernate/test/quote/QuoteTest.java
similarity index 98%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/QuoteTest.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/QuoteTest.java
index b5c33e0313..12ad902f8a 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/QuoteTest.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/QuoteTest.java
@@ -1,93 +1,93 @@
 /*
  * Hibernate, Relational Persistence for Idiomatic Java
  *
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Role.java b/hibernate-core/src/test/java/org/hibernate/test/quote/Role.java
similarity index 89%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Role.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/Role.java
index 2123acc425..d210f12cb8 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/Role.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/Role.java
@@ -1,21 +1,21 @@
 //$Id$
-package org.hibernate.test.annotations.quote;
+package org.hibernate.test.quote;
...
diff --git a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/User.java b/hibernate-core/src/test/java/org/hibernate/test/quote/User.java
similarity index 97%
rename from hibernate-core/src/test/java/org/hibernate/test/annotations/quote/User.java
rename to hibernate-core/src/test/java/org/hibernate/test/quote/User.java
index 81794ea94e..022ea3bd44 100644
--- a/hibernate-core/src/test/java/org/hibernate/test/annotations/quote/User.java
+++ b/hibernate-core/src/test/java/org/hibernate/test/quote/User.java
@@ -1,82 +1,82 @@
 //$Id$
-package org.hibernate.test.annotations.quote;
+package org.hibernate.test.quote;
