diff --git a/spec/tags/1.9/ruby/core/random/equal_value_tags.txt b/spec/tags/1.9/ruby/core/random/equal_value_tags.txt
index a2194facd4..e671b70b9c 100644
--- a/spec/tags/1.9/ruby/core/random/equal_value_tags.txt
+++ b/spec/tags/1.9/ruby/core/random/equal_value_tags.txt
@@ -1,5 +1,3 @@
 fails(JRUBY-4456):Random#== returns true if the two objects have the same state
 fails(JRUBY-4456):Random#== returns false if the two objects have different state
 fails(JRUBY-4456):Random#== returns true if the two objects have the same seed
-fails(JRUBY-4456):Random#== returns false if the two objects have a different seed
-fails(JRUBY-4456):Random#== returns false if the other object is not a Random
diff --git a/spec/tags/1.9/ruby/core/random/new_tags.txt b/spec/tags/1.9/ruby/core/random/new_tags.txt
deleted file mode 100644
index cd2ed7e26f..0000000000
--- a/spec/tags/1.9/ruby/core/random/new_tags.txt
+++ /dev/null
@@ -1,7 +0,0 @@
...
diff --git a/spec/tags/1.9/ruby/core/random/rand_tags.txt b/spec/tags/1.9/ruby/core/random/rand_tags.txt
index 7c1dcf6a68..1a48ea4011 100644
--- a/spec/tags/1.9/ruby/core/random/rand_tags.txt
+++ b/spec/tags/1.9/ruby/core/random/rand_tags.txt
@@ -1,33 +1,31 @@
...
-fails(JRUBY-4456):Random#rand with Range raises an ArgumentError when the startpoint lacks #+ and #- methods
-fails(JRUBY-4456):Random#rand with Range raises an ArgumentError when the endpoint lacks #+ and #- methods
diff --git a/spec/tags/1.9/ruby/core/random/seed_tags.txt b/spec/tags/1.9/ruby/core/random/seed_tags.txt
deleted file mode 100644
index 5398ae224c..0000000000
--- a/spec/tags/1.9/ruby/core/random/seed_tags.txt
+++ /dev/null
@@ -1,5 +0,0 @@
-fails(JRUBY-4456):Random#seed returns an Integer
-fails(JRUBY-4456):Random#seed returns an arbitrary seed if the constructor was called without arguments
-fails(JRUBY-4456):Random#seed returns the same generated seed when repeatedly called on the same object
-fails(JRUBY-4456):Random#seed returns the seed given in the constructor
-fails(JRUBY-4456):Random#seed returns the given seed coerced with #to_int
diff --git a/src/org/jruby/Ruby.java b/src/org/jruby/Ruby.java
index 9a90b2e62c..8913f6f910 100644
--- a/src/org/jruby/Ruby.java
+++ b/src/org/jruby/Ruby.java
@@ -101,3660 +101,3670 @@ import org.jruby.runtime.CallSite;
